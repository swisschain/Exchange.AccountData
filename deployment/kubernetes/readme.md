1. Copy `Service-AccountData` and `Service-AccountData-Worker` to the https://github.com/swisschain/kubernetes-swisschain/tree/master/Kubernetes/03.Pods/Exchange. 
